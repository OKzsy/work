    ...
    for iyoffset in range(ysize):
        for ixoffset in range(xsize):
            ...
            for iflag in range(num_flag):
                flag_p[iyoffset, ixoffset, iflag] = calc_prob(isample_data / 10000, standard_array[iflag, :] / 10000) * 10000
...
if __name__ == '__main__':
    ...
    # box_scale = 1.5
    # out_csv_file = r'D:\Data\Test_data\classification\20180815\standad_spec.csv'
    # out_p_file = r'D:\Data\Test_data\classification\20180815\GF2_20180327_S2_0309_0324_0408_0418_p3.tif'
    # main(in_file, in_dir, out_csv_file, out_p_file)
