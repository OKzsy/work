...
def get_sample_data(in_list):
    #in_file, sample_file, flag_id, size_wind, out_file
    sample_files = in_list[:-3]
    in_file = in_list[-3]
    ...
    for iyoffset in range(top_Left_pixely, bottom_right_pixely, 1):
        for ixoffset in range(top_left_pixelx, bottom_right_pixelx, 1):
            ...
            if (top_Left_pixely < 0) or (top_left_pixelx < 0) or (bottom_right_pixely < 0) \
                ...
                continue
            if (source_dataset.ReadAsArray(ixoffset , iyoffset , 1, 1)[0] <= 0):
                continue
...
def main(in_file, sample_dir, flag_file, size_wind, out_file):
    ...
    input_files = search_file(sample_dir, '.tif')
    ...
    for iproc in range(num_proc):
        ...
        in_list = sub_in_files + [in_file, flag_dict, size_wind]
...
if __name__ == '__main__':
    ...
    # in_file = r"D:\Data\Test_data\classification\yingqiao_20180523+0607_reg_clip2.tif"
    # sample_dir = r"D:\Data\Test_data\classification\sample_tif\yingqiao_tif"
    # size_wind = 7
    # flag_file = r"D:\Data\Test_data\classification\flag_csv.csv"
    # out_file = r'D:\Data\Test_data\classification\yingqiao_20180523+0607_all_csv.csv'
