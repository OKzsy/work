...
if __name__ == '__main__':
    ...
    # in_file=r"\\192.168.0.234\nydsj\user\GF2\clip\luohe\GF2_20180322_L1A0003077263_sha.tif"
    # sample_dir=r"\\192.168.0.234\nydsj\user\DYR\76_小麦\南阳\邓州\3077263\sample"
    # out_dir=r"\\192.168.0.234\nydsj\user\DYR\76_小麦\南阳\邓州\3077263\sample_tif"
    # main(in_file,sample_dir,"Name",out_dir)
    end_time = time.time()
