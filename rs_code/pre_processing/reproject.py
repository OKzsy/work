...
def reproject_dataset(src_ds, Res):
    """
...
def main(in_dir, out_dir, Res, partfileinfo):
    # 搜索需要处理的影像
    ...
    for ifile in Pending_images:
        ...
        # 重投影
        dest = reproject_dataset(dataset, Res)
        # 拼接输出影像绝对路径
...
if __name__ == '__main__':
    ...
    main(in_dir, out_dir, Resolution, partfileinfo)
    end_time = time.clock()
