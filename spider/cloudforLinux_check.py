...
class Nasa:
    def __init__(self, product="MOD35_L2", collection="61", date=None, latlng=None, save_path=None):
...
def hdf2tiff(date, latlng, save_path, stitch_path, aod_dir):
    ...
    lun_stitch.write("{:<} = {}{}".format("OBJECT_NAME", "mod35|", '\n'))
    lun_stitch.write("{:<} = {}{}".format("FIELD_NAME", "Cloud_Mask|", '\n'))
    ...
    lun_stitch.write("{:<} = {}{}".format("OUTPUT_OBJECT_NAME", "mod35|", '\n'))
    lun_stitch.write("{:<} = {}{}".format("OUTGRID_X_PIXELSIZE", 0.011784, '\n'))
    lun_stitch.write("{:<} = {}{}".format("OUTGRID_Y_PIXELSIZE", 0.009034, '\n'))
...
def main(date, latlng, aod_dir):
    ...
    hdf_path = os.path.join(function_position, 'cloud_hdf', date.replace("-", ""))
...
if __name__ == '__main__':
    ...
    aod_dir = r"/home/zhaoshaoshuai/cld"
